...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "This function can be called only by the owner");
        _;
    }
...
contract Pausable is Ownable {
    ...
    {
        require(!_paused, "The contract must be running (unapaused)");
        _;
    }

    modifier whenPaused()
    {
        require(_paused, "The contract must be paused");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "the given address cannot already own tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "the caller has to be the token owner");
...
// NOTE TO REVIEWER: mint(...) doesn't need a tokenURI, as setTokenURI accepts a uint
contract CustomERC721Token is ERC721Metadata("Real Estate","RE","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
